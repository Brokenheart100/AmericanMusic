...
Rectangle {
    ...
    property var player: musicPlayer
    ColumnLayout {
        anchors.fill: parent
        ...
        RowLayout {
            ...
            RowLayout {
                ...
                SongInfo {
                    id: songInfoArea
                    coverSource: root.player.currentCoverSource
                    title: root.player.currentTitle
                    artist: root.player.currentArtist
                }
                IconButton1 {
                ...
                Component.onCompleted: {
                    console.log("Current cover source:", coverSource, "Title:", title, "Artist:", artist);
                }
            }
            Item {
                Layout.fillWidth: true
